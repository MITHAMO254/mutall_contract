...
$client_title = "<u>OLGILAI CONSTRUCTORS LTD</u>";
$client_name = "OLGILAI";
//
...
$room_id = "30";
$room_name = "Building and Civil Engineering Constructors";
...
<!--        <header id="header" class="">
        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                <no>1. The Renewal of <?php echo $client_name?> Lease Agreement.</no>
                <content>
                    <agreement>
                    ...
                    Act and licensed to carry on Building and Civil Engineering Construction 
                    business under the whose address for purposes hereof is <u>Post 
                    Office Box Number 634-00206 Kiserian. </u> in the said 
                    ...
                    conveniences.<br>
                    That floor space comprising by measurement <u>444</u> 
                    square feet or 
                    thereabout of  lettable space on the <u>second floor</u> of the
                    Building.<br>
                    The Term of Five (5) years from <u><b>2020 August 1<sup>st</sup></b></u><br>
                    ...
                    <?php echo $landlord_name;?> may endeavor to make 
                    ...
                    for the purpose  of inspection, altering, or repairing 
                ...
                <section id="s2">
                    ...
                    <content>
                        ...
                        <specific style="color: blue">
                            ...
                            <article>
                                ...
                                Shillings Kshs 22,200 (without VAT) which shall 
                    ...
                    2.1.3-Rent shall be increased at the rate of 10%
                          ...
                          the rent shall be:- sh 22,200+(10%of sh22,200) 
                          = sh 24,420.<br>
                    2.1.4-<?php echo $client_name;?> agrees to pay 2 times gross 
                          ...
                          hereinafter provided; this amount tos sh 44,400<br>
                    </div>
                </specific>
                <div id="s2_2">
                <span>
                ...
                <specifics>
                        ...
                        non-payment,we will use the deposity to offset the bill.
