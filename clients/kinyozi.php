...
$client_title = "<u>PROUDLY KENYAN INVESTMENT </u>";
$client_name = "KINYOZI";
//
...
<!--        <header id="header" class="">
        ...
        <aside class="nav" id="myNav">
            ...
            <a href="#s1">1.Renewal of <?php echo $client_name;?> contract</a>
        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                ...
                <content>
                    ...
                    Act and licensed to carry on Spa and Barbar shop business under the 
                    whose address for purposes hereof is <u>Phone No. 0722 350 361 Lillian.</u> in the said 
                    ...
                    conveniences.<br>
                    That floor space comprising by measurement <u>517.1</u> 
                    square feet or 
                    thereabout of  lettable space on the <u>first floor</u> of the
                    Building.<br>
                ...
                <section id="s2">
                    ...
                    <content>
                        ...
                        <specific style="color: blue">
                            ...
                            <article>
                                ...
                                per square foot translating to a total monthly rent 
                                of Kshs 25,850 (without VAT) which shall be as from  
                                2020/03/01 as follows:-<br>
                            </article>
                            ...
                            <tr>
                                ...
                                <td><?php echo $client_name;?> main barbar shop</td>
                                <td><nm>323</nm></td>
                                <td><nm>16,150</nm></td>
                            </tr>
                            <tr>
                                <td><?php echo $client_name;?>_extension</td>
                                <td>room area outside kinyozi</td>
                                <td><nm>194</nm></td>
                                <td><nm>9,700</nm></td>
                            </tr>
                            <tr>
                    ...
                    2.1.2-Rent shall be paid on a monthly basis in advance not
                    ...
                    2.1.3-Rent shall be increased at the rate of 10%
                          ...
                          the rent shall be:- sh 25,850+(10%of sh25,850) 
                          = sh 28,435<br>
                    2.1.4-<?php echo $client_name;?> agrees to pay 2 times gross 
                          ...
                          hereinafter provided; this amounts to sh 51,700<br>
                    </div>
                </specific>
                <div id="s2_2">
                <span>
                    ...
                    <br>2.2.1-Water charges shall be sh 300 per unit, to
                        be renewed atfer 2 years. 
                    <br>2.2.2-Your water serial No. is 18031498.<br>
                    <br>2.2.3-To pay 2 times monthly water consumption in the 
                        previous term as deposit which sum shall be held by 
                        <?php echo $landlord_name;?> to the credit of <?php echo $client_name;?>'s
                        account and applied as hereinafter provided; this amounts to sh 1,600.
                    </div>
                    </specifics>
                        <span>
                    ...
                    <specifics>
                        ...
                        through A/C No. 29304136.<br>
                        2.3.2 Your electricity meter number is 60330355.<br>
                        2.3.3 You will pay a deposit of sh 5,000 for electricity.<br>
                        2.3.4 Should KPLC threatens to cut their supply due to your
                        non-payment,we will use the deposity to offset the bill, and you will be
                        required to top up your deposit after such an eventuality.<br>
                        </div>
                </specifics>
                <span>
                    2.4 Security:
                ...
                <specifics>
                    <div style="list-style-type: none; padding-left: 30px;">
                    2.4.1 <?php echo $client_name;?> is exempted from security chages for you 
                    shall provide your own day and night security.<br>
                    </div>
                </specifics>
                <span>
                    2.5 Service charge.
                ...
                <article>
                    ...
                    <li style="list-style-type: none; padding-left: 30px;  line-height: 2em;">
                            ...
                            <? php echo "$client_name ?> as practicable 
                ...
                <content>
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            <?php echo $client_name; ?> to be performed and observed 
