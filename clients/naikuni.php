...
//
//Date of agreement
$date = "<b>2020 March 1<sup>st</sup></b>";
//
...
$client_title = "<u>NAIKUNI,NGAAH & MIENCHA COMPANY ADVOCATES.</u>";
$client_name = "NAIKUNI";
//
...
<!--        <header id="header" class="">
        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                <no>1.Renewal of <?php echo $client_name?> Contract</no>
                <content>
                    <agreement>
                    ...
                    <br></b>
                    <p>LEASE<br>
                    <p>THIS LEASE is made the  day of  <b>2020 March. 1<sup>st</sup></b><br></p>
                    BETWEEN
                    ...
                    Act and licensed to carry on law firm business under the 
                    whose address for purposes hereof is <u>Post 
                    Office Box Number 345-00206 Nairobi. </u> in the said 
                    ...
                    conveniences.<br>
                    That floor space comprising by measurement <u>432</u> 
                    square feet or 
                    thereabout of  lettable space on the <u>second floor</u> of the
                    Building.<br>
                    The Term of Five (5) years from <b>2020 August 1<sup>st</sup></b><br>
                    C) <?php echo $landlord_name;?> has agreed to grant a Lease of the 
                    premises forming a portion of the building more 
                    particularly as it described in section 2.1 
                    ...
                    and <?php echo $landlord_name;?> DOES HEREBY LEASE 
                    unto  <?php echo $client_name;?>.
                    ...
                    grant the same, with the free passage and  running of water 
                    and electricity from and to the Demised Premises through 
                    the pipes, wires, cables and meters in  or under 
                    ...
                    the free passage and running of the water and electricity 
                    from the adjoining or adjacent property through the 
                    ...
                    and in the manner descibed in section 2.1.
                </content>
                </section>
                <section id="s2">
                    ...
                    <content>
                        ...
                        <specific style="color: blue">
                                ...
                                <table border="1">
                            <article>
                                2.1.1 To pay rent calculated at the rate of Kshs 50/=
                                per square foot translating to a total monthly rent of Kenya 
                                Shillings Kshs 21,600 (without VAT) which shall 
                                be as from 2020-08-01 as follows:-<br>
                            </article>
                            
                            <tr>
                            <td>Room identifier</td>
                            <td>Room Description</td>
                            <td>Area squre feet</td>
                            <td>Rent amount@ <u>sh50/ft</u><sup>2</sup></td>
                            </tr>
                            <tr>
                                <td>Law Firm</td>
                                <td><?php echo $client_name;?> business room</td>
                                <td><nm>432</nm></td>
                                <td><nm>21,600</nm></td>
                            </tr>
                            <tr>
                    ...
                    2.1.2-Rent shall be paid on a quarterly basis in advance not
                          later than the 5<sup>th</sup> of that month when it is due.
                          <br>If paid later than that date, it will attract a charge of 10% per
                          day up to a maximum of one month thereafter to start 
                          recovery produres of the same.<br>
                    2.1.3-Rent shall be increased at the rate of 10%
                          after every 2 years of the term. So in two year's time 
                          the rent shall be:- sh 21,600+(10%of sh21,600) 
                          = sh 23,760.<br>
                    2.1.4-<?php echo $client_name;?> agrees to pay 2 times gross 
                          monthly rent as deposit which sum shall be held by  
                          <?php echo $landlord_name;?> to the credit
                          of <?php echo $client_name;?> account and applied as 
                          hereinafter provided; this amounts to sh 43,200<br>
                    </div>
                </specific>
                <div id="s2_2">
                <span>
                ...
                <specifics>
                    <div style="list-style-type: none; padding-left: 30px;">
                        <br>2.2.1-You shall use water from the common mutall tap at first floor.<br>
                        <br>2.2.2- You will pay a stand charge of sh 300 per month for water.
                        </div>
                </specifics>
                        <span>
                ...
                <specifics>
                        ...
                        through A/C No. 40490757.<br>
                        2.3.2 Your electricity meter number is 61431466.<br>
                        2.3.3 You will pay a deposit of sh 5,000 for electricity.
                        2.3.4 Should KPLC threatens to cut their supply due to your
                        non-payment,we will use the deposity to offset the bill,you
                        will top up your deposit after such an eventuality.<br>
                        </div>
                </specifics>
                <span>
                    2.4 Security:
                ...
                <specifics>
                    <div style="list-style-type: none; padding-left: 30px;">
                    2.4.1 <?php echo $client_name;?> shall pay sh 2,000 per month
                    for security services provided by <?php echo $landlord_name;?> 
                    in the building.<br>
                    </div>
                </specifics>
                <span>
                ...
                <article>
                    To pay to <?php echo $landlord_name;?> by way of additional 
                    rent a Service Charge which is proportional to the operating 
                    expenses of the Building that the floor space of the Premises 
                    bears to the floor space of the lettable area of the Building 
                    such Service Charge to be paid with the Rent monthly in 
                    advance and shall be in respect of the amount from time
                    to time expended by <?php echo $landlord_name;?>.<br>
                    <specifics>
                    <?php echo $client_name;?> shall pay Service Charge at the monthly rate of Ksh 2,000.<br>
                    Service charge will be reviewed bi-annually at the rate of 10% of the 
                    pre-existing amount.
                    </specifics>
                    ...
                    <li style="list-style-type: none;  line-height: 2em;">
                        ...
                        Building and the windows plus the toilets therein and the costs 
                    ...
                    <li style="list-style-type: none;  line-height: 2em;">
                        ...
                        <br>This is the costs for the upkeep of the Land.
                    ...
                    <li style="list-style-type: none;  line-height: 2em;">
                        ...
                        sum to <?php echo $client_name;?> upon the expiration of the
                        Term unless the same shall have been applied by  
                        <?php echo $landlord_name;?> to any of <?php echo $client_name;?> 
                        obligations under this Lease.<br>
                        The following provisions shall apply in respect of 
                        this Sub-Clause 2.5.5<br>

                    <li style="list-style-type: none; padding-left: 30px;  line-height: 2em;">
                            <br> 2.5.5.1 The computation:<br>
                            ...
                            2.5.5.3 Ascertainement of service Charge:<br>
                            ...
                            during the Financial Year to which it relates.<br>
                            2.5.5.5 Supply:<br>
                            ...
                            2.5.5.6 The ten (10) days of demand:<br>
                            In the event that payments made by the 
                            <?php echo $client_name?> and other <?php echo $client_name?>
                            on account of Service Charge are less than the actual 
                            Service Charge expenses of  <?php echo $landlord_name;?>  
                            <? php echo "$client_name ?> shall within 
                            ten (10) days demand for such additional amount 
                            ...
                            <br> 2.5.5.7 Reimbursement/Credit note:<br>
                            In the event that payments made by the <?php echo $client_name?>
                            on account of Service Charge are more than the actual Service Charge 
                            expenses of <?php echo $landlord_name;?> 
                ...
                <span>
                    ...
                    to the credit of <?php echo $client_name;?>'s account. 
                    </div>
                <specifics>
                    <div style="list-style-type: none; padding-left: 30px;">
                    <table border="1">
            ...
            <specifics>
                ...
                passed over to the Kenya Revenue Authority, calculated as follows;
                16% *(21,600 + 2,000) i.e sh 3,776.
                </div>
            </specifics>
                    <div id="s2_9">
                        <span>
                    ...
                    <div id="s2_11">
                        ...
                        <article>
                            ...
                            <?php echo $landlord_name;?> who shall be entitled as 
                            a condition of giving such consent to demand such additional
                            service charge  or rent as may suffice to cover the 
                            additional charges for water and power caused by such use.
                        </article>
                    </div>
                    <div id="s2_12">
                        <span>
                        ...
                        <article>
                            ...
                            <? php echo "$client_name ?> repair and condition
                            to the reasonable satisfaction of  <?php echo $landlord_name;?> 
                            and also to permit <?php echo $landlord_name;?> or its agents  
                            with or without workmen and others at all reasonable 
                            times during all reasonable working hours to enter into 
                            and upon the Demised Premises with prior notice to 
                            <?php echo $client_name;?> for the purpose of painting,  
                            repairing or otherwise dealing with the outside 
                            door or doors entering into the Demised Premises and 
                            the outside of all window frames in the Demised Premises;
                            <?php echo $landlord_name; ?> causing as little inconvenience 
                    ...
                    <div id="s2_14">
                        ...
                        <article>
                            ...
                            style and of such color or occurs as  <?php echo $landlord_name;?>  
                            may reasonably determine all the inside parts of the Demised 
                    ...
                    <div id="s2_15">
                        ...
                        <article>
                            ...
                            unless and until the weight of each such thing 
                            (and in the case of business machines and mechanical 
                            equipment thereof with a view to the 
                            absorption and prevention of vibration noise annoyance)
                    ...
                    <div id="s2_17">
                        ...
                        <article>
                            ...
                            others and with all necessary tools, appliances and 
                            apparatus at any time with prior notice to enter upon 
                            ...
                            that the rent hereby reserved shall not in any way be abated 
                    ...
                    <div id="s2_19">
                        ...
                        <article>
                            Not to make without the previous consent of  
                            <?php echo $landlord_name;?>, first had and obtained 
                            (which consent shall not be unreasonably withheld) 
                            structural alterations,partitions or structural additions 
                            in or to the Demised Premises or to  <?php echo $landlord_name;?>s 
                            fixtures. If  <?php echo $landlord_name;?> shall grant
                            ...
                            <li>
                               (iii)Any such alterations partitions additions 
                                ...
                                be forfeited to  <?php echo $landlord_name;?> at the expiry or sooner 
                    ...
                    <div id="s2_20">
                        ...
                        <article>
                            ...
                            costs and Surveyor's fees) incurred by  <?php echo $landlord_name;?> for 
                    ...
                    <div id="s2_21">
                        ...
                        <article>
                            ...
                            the current premium. It is also  <?php echo $client_name;?> 
                            resposibility to insure its equipment, fittings and 
                            fixtures against fire  theft and other perils.
                        </article>
                        </div>
                    <div id="s2_22">
                        <span>
                        ...
                        <article>
                            ...
                            increased AND to repay to <?php echo $landlord_name;?> 
                            all sums paid by way of increased premium and all 
                            expenses incurred by it in or about the .renewal of 
                            any such policy rendered necessary by a broach of It 
                            is covenant and agreement and to the intent that  such 
                            payments shall be payable on the  day fixed tor the 
                            payment of the rent hereinbefore reserved next after
                            demand therefor shall have been made to  
                            <?php echo $client_name;?> and shall be recoverable 
                            ...
                            covenant to indemnity  <?php echo $landlord_name;?> 
                            in respect of of the cost or a proportionate part 
                    ...
                    <div id="s2_23">
                        ...
                        <article>
                            ...
                            against fire effected thereon by <?php echo $landlord_name;?>  
                            being wholly or partially irrecoverable by reason solely on 
                            the part of any act or default of  <?php echo $client_name;?>    
                            or <?php echo $client_name;?> servants, employees, agents, 
                            licensees or visitors then and in every such case forthwith 
                            (in addition to the said rent) to pay to <?php echo $landlord_name;?> 
                            ...
                            contributed by  <?php echo $client_name;?> or otherwise 
                            in respect of or arising out of this provision to be 
                            referred to arbitration in accordance with the provisions 
                            of the Arbitration Ad 1995 or any Act or Acts amending or 
                            replacing the same.
                        </article>
                        </div>
                    <div id="s2_24">
                        ...
                        <article>
                            ...
                            without notice and thereupon the Term shall determine 
                            absolutely. If this lease be transferred or it the 
                            Demised Premises or any part thereof be sublet or occupied 
                            by any person other than  <?php echo $client_name;?>, 
                            <?php echo $landlord_name;?> may after default by   
                            <?php echo $client_name;?>  collect the rent from the 
                            ...
                            transferee, sub lessee or occupant as <?php echo $client_name;?> 
                            or a release of <?php echo $client_name;?> of the covenants 
                            and agreements on <?php echo $client_name;?>'s part  
                            herein contained. 
                        </article>
                        </div>
                    <div id="s2_25">
                        ...
                        <article>
                            ...
                            otherwise than as a <?php echo $client_name;?> premises and for ancillary 
                    ...
                    <div id="s2_26">
                        ...
                        <article>
                            Not to paint affix or exhibit any name or 
                            ...
                            <?php echo $landlord_name;?> at or near the entrance of the Building or 
                            the private entrance or doorway to the Demised Premises 
                            or such Other place as the case may be in such manner 
                            in each case as shall conform with the permitted of 
                            other <?php echo $client_name;?> (if any) and as shall from 
                            time to time be approved by  <?php echo $landlord_name;?>
                        </article>
                        </div>
                    <div id="s2_27">
                        <span>
                        ...
                        <article>
                            ...
                            consent in writing of  <?php echo $landlord_name;?>
                            first and obtained nor without the like consent 
                            to bring or permit to be brought or kept in or on the 
                            Demised Premises any Inflammable combustible or explosive
                            fluid, material, chemical or substance nor cause nor 
                            permit any objectionable odours to permeate from the 
                            Demised Premises.
                        </article>
                    </div>
                    <div id="s2_30">
                        ...
                        <article>
                            ...
                            opinion of  <?php echo $landlord_name;?> may be or 
                            become a nuisance or annoyance to or in any way 
                            interfere with the quiet user of the other portions 
                            of the Building or any adjoining or neighboring premises.
                        </article>
                        </div>
                    <div id="s2_31">
                        <span>
                    ...
                    <div id="s2_33">
                        ...
                        <article>
                            ...
                            or conduct of the Demised Premises AND to obtain all 
                    ...
                    <div id="s2_37">
                        ...
                        <article>
                            ...
                            agreement shall survive expiration or other 
                            determination of the Term AND if the last day of the 
                            Term shall fell on a Sunday or Public Holiday, this lease 
            ...
            <section id="s3">
                <no>3. Additional obligation of <?php echo $client_name?>.</no>
                <content>
                    <p>
                    <div>
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            <?php echo $client_name; ?> 'without the prior consent 
                            of  <?php echo $landlord_name;?> in each instance, 
                ...
                <content>
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            <?php echo $client_name;?>s to be performed and observed 
                            or if  <?php echo $client_name;?> 
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            shall occur as aforesaid <?php echo $landlord_name;?> 
                            or die <?php echo $client_name;?> as 
            ...
            <section id="s6">
                ...
                <content>
                    ...
                    <list>
                    <li>
                        (i) <?php echo $landlord_name; ?> shall return the said 
            ...
            <section id="s8">
                ...
                <content>
                    <p>
                        ...
                        hereinafter provided <?php echo $landlord_name;?> shall 
                        grant to Use <?php echo $client_name;?> 
                        ...
                        receipt by <?php echo $landlord_name;?> 
                        of  <?php echo $client_name;?>s notice to renew this 
            ...
            <section id="s11">
                ...
                <content>
                    <div>
                        ...
                        written SEALED with the common seat of THE MUTALL in 
                        the presence of:-<br> 
                        ...
                        Secretary of <?php echo $landlord_name;?> and <?php echo $client_name; ?> 
                        respectively appeared before me on the day 
                        of......................... 2020 and (being Known to me)
                        acknowledged the above signatures or mark to be theirs and
                        that they had freely and voluntarily executed this instrument
                        and understood its contents.<br>
