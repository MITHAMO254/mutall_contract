...
$client_title = "<u>GEOCAD ENTERPRISES LTD</u>";
$client_name = "GEOCAD";
//
//The title no. of the premises.
$title = "<b><u>NGONG/NGONG/17140</u></b>";
//
//Ref name of the agreement.
$room_id = "27";
$room_name = "Land Surveyors and Property Agent";
...
<!--        <header id="header" class="">
        ...
        <aside class="nav" id="myNav">
            ...
            <a href="#s4">4.Addtional Obligation of <?php echo $landlord_name;?></a>
        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                <no>1.Renewal of <?php echo $client_name?> Lease Agreement.</no>
                <content>
                    <agreement>
                        <p>DATED <data><?php echo $date; ?></data></p>
                        <p><data><b><?php echo $landlord_title;?></b></data></p>
                        <p>TO</P>
                        <p><data><b><?php echo $client_title;?></b></data></p>
                        <p>LEASE<br>
                    ...
                    <br></b>
                    <p>LEASE<br>
                    <p>THIS LEASE is made the  day of  <u>2020-02-25</u><br></p>
                    BETWEEN
                    ...
                    Act and licensed to carry on law farm business under the 
                    whose address for purposes hereof is <u>Post Office 
                    Box Number 696-00206 Kiserian</u> in the said 
                    ...
                    conveniences.<br>
                    That floor space comprising by measurement <u>294</u> 
                    square feet or 
                    thereabout of  lettable space on the <u>second floor</u> of the
                    Building.<br>
                    The Term of Five (5) years from <u>2020-08-01.</u><br>
                ...
                <section id="s2">
                    ...
                    <content>
                        ...
                        <specific style="color: blue">
                            ...
                            <article>
                                ...
                                Shillings Kshs 14,700 (without VAT) which shall 
                    ...
                    2.1.3-Rent shall be increased at the rate of 10%
                          ...
                          the rent shall be:- sh 14,700+(10%of sh14,700) 
                          = sh 16,170.<br>
                    2.1.4-<?php echo $client_name;?> agrees to pay 2 times gross 
                          ...
                          hereinafter provided; this amount tos sh 29,400<br>
                    </div>
                </specific>
                <div id="s2_2">
                <span>
                ...
                <specifics>
                    <div style="list-style-type: none; padding-left: 30px;">
                        <br>2.2.1 You shall use water from the common mutall tap at second floor.<br>
                        <br>2.2.2 Water charge shall be sh 300 per unity.<br>
                ...
                <specifics>
                        ...
                        through A/C No. 44573236.<br>
                        2.3.2 Your electricity meter number is 60585182.<br>
                        2.3.3 You will pay a deposit of sh 5,000 for electricity.<br>
                ...
                <article>
                    ...
                    Service charge leviewed bi-annually at the rate of 10% of the 
                    pre-existing amount.
                    </specifics>
            ...
            <specifics>
                ...
                16% *(14,700 + 2,000) i.e sh 2,672.
                    ...
                    <div id="s2_12">
                        <span>
                            2.12 MaintAdditionalenance.
                        </span>
                        <article>
                            To keep the Demised Premises in good and substantial 
                            <? php echo "$client_name ?>able repair and condition
                            to thereasonable satisfaction of  <?php echo $landlord_name;?> 
                    ...
                    <div id="s2_24">
                        ...
                        <article>
                            ...
                            herein contained. For the purpose of this sub-clause 
                            and of the last preceding sub-clause if <?php echo $client_name;?>
                            is a private or public limited liability company the 
                            transfer of the beneficial interest in more than fifty 
                            per cent (50%) of its issued share capital shall be 
                            deemed lo be a transfer .
                        </article>
                        </div>
                    <div id="s2_25">
                        <span>
                    ...
                    <div id="s2_26">
                        ...
                        <article>
                            ...
                            me to time be approved by  <?php echo $landlord_name;?>
                        </article>
                        </div>
                    <div id="s2_27">
                        <span>
                        ...
                        <article>
                            ...
                            first had and obtained nor without the like consent 
            ...
            <section id="s4">
                <no>4. Additional Obligation of <?php echo $landlord_name;?>.</no>
                <content>
                    <p>
                    <div>
