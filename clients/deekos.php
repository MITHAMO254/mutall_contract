        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                ...
                <section id="s2">
                    ...
                    <content>
                        ...
                        <specific style="color: blue">
                                ...
                                <table border="1">
                            <article>
                                2.1.1 To pay rent as shown bellow translating to a total monthly rent of Kenya 
                                Shillings Kshs 211,725 (without VAT) which shall 
                            ...
                            <td>Rate (Kshs) /ft<sup>2</sup><br></td>
                            <td>Rent amount</td>
                            </tr>
                            <tr>
                                <td>deekos_bakery</td>
                    ...
                    2.1.2 The cafeteria_extension(*) will not be charged for the 1<sup>st</sup>
                          year but from the 2<sup>nd</sup>year it will be
                          charged at the rate of sh60/ft<sup>2</sup><br>
                    2.1.3 Rent shall be paid on a quarterly basis in advance not
                    ...
                    2.1.4 Rent shall be increased at the rate of 10%
                          after every 2 years of the term. So in two year time 
                          the rent shall be:- sh 211,725+(10%of sh211,725) 
                          = sh 232,898<br>
                    2.1.5 DEEKOS agrees to pay 2 times gross monthly rent as deposit which 
                          sum shall be held by <?php echo $landlord_name;?> to the credit
                          of <?php echo $client_name;?> account and applied as 
                          hereinafter provided this amount sh 423,450<br>
                    </div>
                </specific>
                <div id="s2_2">
                <span>
                ...
                <span>
                    ...
                    to the credit of <?php echo $client_name;?> account. 
                    </div>
                <specifics>
                    <div style="list-style-type: none; padding-left: 30px;">
                    <table border="1" >
            ...
            <specifics>
                ...
                16% *(211,725 + 5,000) i.e sh 34,676
                </div>
            </specifics>
                    <div id="s2_9">
                        <span>
                    ...
                    <div id="s2_15">
                        ...
                        <article>
                            ...
                            position intended AND ALSO NOT to load the floors beyond 
