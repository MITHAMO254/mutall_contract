        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                ...
                <section id="s2">
                    ...
                    <?php 
                    foreach($rent_payment as $rent_payment_details){
                    echo"<li>$rent_payment_details[0]</li>";
                    }
                    ?>
                ...
                <span>
                    ...
                    hereinafter provided this amount to sh 600.<br>
                    <div style="list-style-type: none; padding-left: 30px;">
                    <br>2.2.1-Water charges shall be sh 300 per unit, to
                        be renewed atfer 2 years.<br> 
                    <br>2.2.2-Your water serial No. is 18031498.
                    </div>
                    </specifics>
                        <span>
