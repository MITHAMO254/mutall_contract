...
$client_title = "THE DEEKOS BAKERS LIMITED";
$client_name = "deekos";
//
...
//
//legal authority.
$lawyer ="Waweru Munyi<br> Advocate<br>
            Kiserian,Kajiado Count<br>
            Mutall Building,first floor<br>
            At Co-operative Bank<br>
            PO Box 365-00206<br>
            Kiserian Town
            ";
//
//get the specific client file to drive the contract template
require_once './clients/waweru.php';
?>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="container" id="main" onclick="closeNav()">
            <section id="s1">
                        ...
                        <content>
                            ...
                            BETWEEN
                            <p><data> 1. <b><?php echo $landlord; ?></b></data> 
                             whose address for purposes hereof is care of Post Office 
                             Box Number 374-00206 Kiserian, in the Republic of Kenya 
                             (hereinafter called the Landlord" which expression shall 
                             where the context so admits include its successors and 
                             assigns} of the one pair;
                            </p>
                            <br>AND
                            <p><data> 2. <b><?php echo $client_title; ?></b></data> 
                            a body corporate duly established under the Companies 
                            Act and licensed to cany on banking business under the 
                            Banking Act whose address for purposes hereof is Post 
                            Office Box Number 46231- 00100 Nairobi in the said Republic 
                            ...
                            <b>WHEREAS:-</b>
                            <p>
                            A)The Landlord is registered as the proprietor of ALL 
                            THAT piece of land TITLE NO. <data><?php echo $title; ?></data> 
                            together with all buildings and improvements erected and 
                            being thereon (hereinafter called the “land").
                            </p>
                            <p>
                            B) The Landlord has  erected a building on the said 
                            piece or parcel of land (hereinafter called "the Building") 
                            which comprises inter alia offices, shops and the usual 
                            conveniences;
                            </p>
                            <p>
                            C) The Landlord has agreed to grant a Lease of the 
                            premises forming a portion of the building more 
                            particularly descnbed in the First Schedule hereto 
                            (“hereinafter called "the Demised Premises!to the 
                            Tenant under the terms and conditions hereinafter 
                            mentioned.
                            </p
                            ...
                            and of the covenants and agreements by the Tenant 
                            hereinafter contained the Landlord DOES HEREBY LEASE 
                            unto the Tenant ALL THAT the Demised Premises TOGETHER 
                            WITH the night to the Tenant and all persons authorised 
                            by the Tenant in common with the Landlord and the other 
                            tenants and occupiers (if any) of the Building and all 
                            persons duly authorised   by them (not otherwise lessees 
                            to  use  the entrance halls and staircases, landings,  
                            passages for the purposes only of ingress to and egress 
                            from the Building during the business hours hereinafter 
                            defined or as may from time to time be determined by the 
                            Landlord 
                            <b>PROVIDED THAT</b> 
                            if the Tenant shall give to the landlord  or  its  
                            agent  reasonable notice  of such  Tenants  desire  
                            the Landlord  will  endeavor to make suitable arrangements 
                            for the Tenant  and members of  the Tenant' s staff  
                            to  obtain  access  to  the Demised Premises at such 
                            other times as the Tenant mayrequire 
                            ...
                            the same may be allocated by the Landlord
                            <b>AND TOGETHER ALSO</b> 
                            in common with all other persons  entitled thereto and
                            so far only as the Landlord has power to grant the 
                            same, with the free passage and  running of water,soil 
                            ...
                            <b>BUT EXCEPTING AND RESERVING</b> 
                            unto the Landlord and the person or persons for the 
                            time being occupying any other part or parts of the 
                            Building the free passage and running of the water, 
                            soil and electricity from the adjoining or adjacent 
                            property through the drains, pipes, wires, cables and 
                            meters in or under the Demised Premises and the right 
                            of the Landlord to enter the Demised Premises at all 
                            reasonable times by prior appointment for the purpose 
                            of inspection, altering, adding to or repairing the same 
                            <b>TO BE HELD</b> 
                            by the Tenant as lessee for a Term more particularly  
                            described  in  the  Second  Schedule  (hereinafter called 
                            “the Term) 
                            <b>SUBJECT</b> 
                            nevertheless to determination as hereinafter provided 
                            <b>YIELDING AND</b> 
                            therefor end thereout  during theTerm the rent in the
                            amount and in the manner Third Schedule.
                        </content>
            </section>
            <section id="s2">
                ...
                <content>
                    <div>
                        <p>
                          The Tenant to the intent that the obligations set out 
                          may continue throughout the continuance of the Term 
                          hereby created covenants and agrees with the Landlord 
                          as follows:-
                        </p>
                    </div>
                    <div id="s2_1">
                        ...
                        <article>
                            ...
                            manner aforesaid clear of all deductions whatsoever;
                        </article>
                        <specifics>
                            <ol type="a">
                                <?php 
                                    foreach ($rent_payment as $rent_details){
                                        echo "<ol type='a'><li>$rent_details[0]</li></ol>";
                                    };
                                ?>
                            </ol>
                        </specifics>
                    ...
                    <div id="s2_2">
                        ...
                        <article>
                            ...
                            it chargeable in respect of any payment made by the 
                            Tenant under any of terms of or in connection with this 
                            Lease or in respect of any payment made by the Landlord 
                            where the Tenant agrees in this Lease to reimburse the 
                            Landlord for such payment; 
                         </article>
                        <specifics>
                                <?php foreach ($vat as $vat_details){
                                    echo "<ol type='a'><li>$vat_details[0]</li></ol>";
                                };?>
                    ...
                    <div id="s2_3">
                        ...
                        <article>
                            To deposit with the Landlord forthwith the sum more 
                            particularly described in the Fourth Schedule being 
                            the equivalent of three months gross rent as a security 
                            deposit which sum shall be held by the Landlord to the 
                            credit of the Tenant's account and applied as hereinafter 
                            provided.
                        </article>
                        <specifics>
                            
                                <?php foreach ($deposit as $deposit_details){
                                    echo "<ol type='a'><li>$deposit_details[0]</li></ol>";
                                };?>
                    ...
                    <div id="s2_4">
                        ...
                        <article>
                            To pay all charges in respect of water and electricity   
                            installed in the Demished Premises as the same become due.
                        </article>
                        <specifics>
                        <?php foreach ($Utility as $Utility_details){
                                    echo "<ol type='a'><li>$Utility_details[0]</li></ol>";
                                };?>
                    ...
                    <div id="s2_5">
                        ...
                        <article>
                            ...
                            Demised Premises to pay to the Landlord the cost of 
                            supplying and installing a meter AND to pay for all water 
                            so supplied to the   Demised Premises AND to indemnify the 
                            Landlord against all actions proceedings claims and demands 
                            arising from any leakage or overflow of water from the 
                            Demised Premises save where such overflow or leakage is 
                            for causes not attributable to the Tenant or any of its 
                    ...
                    <div id="s2_6">
                        ...
                        <article>
                            ...
                            possession without the written consent of the Landlord. 
                            If the Tenant shall for any reason vacate the Demised 
                            Premises without the written consent of the landlord or 
                            stop carrying on the business the Demised Premises were 
                            demised for then it shall become lawful for the Landlord 
                            ...
                            Demised Premises with the Landlord's consent as aforesaid 
                            the Tenant shall provide such caretaking and security 
                            arrangements as the Landlord and/or its insurers shall 
                            require up to such date and time as the Tenant shall 
                    ...
                    <div id="s2_7">
                        ...
                        <article>
                            ...
                            or electric power without the prior written consent of the 
                            Landlord who shall be entitled as a condition of giving such 
                    ...
                    <div id="s2_8">
                        ...
                        <article>
                            ...
                            satisfaction of the Landlord and also to permit the 
                            Landlord or its agents with or without workmen and 
                            others at all reasonable times during all reasonable 
                            working hours to enter into and upon the Demised Premises 
                            with prior notice to the Tenant for the purpose of 
                            ...
                            the Landlord causing as little inconvenience as necessary 
                    ...
                    <div id="s2_10">
                        ...
                        <article>
                            ...
                            style and of such color or occurs as the Landlord may 
                            ...
                            manner and to the reasonable satisfaction of the Landlord 
                            PROVIDED ALWAYS that nothing herein contained shall 
                            require the Tenant to put or keep the Demised Premises 
                    ...
                    <div id="s2_11">
                        ...
                        <article>
                            ...
                            shall have first been approved in writing by the Landlord's 
                            ...
                            Note that if the Building management comes in do what 
                            the tenant is supporsed to do,then it will be on cost+15% 
                            service charge on the tenant.
                            </ol>  
                    </div>
                    <div id="s2_12">
                        <span>
                        ...
                        <article>
                            To permit any agent employed by the Landlord or the 
                            Landlord to enter the Demised Premises for purposes 
                            of inspecting the same and in the ordinary course of 
                            his duty in the company of a member of the Tenant's 
                    ...
                    <div id="s2_13">
                        ...
                        <article>
                            To permit the Landlord and its agents and all other 
                            ...
                            the Landlord in that behalf hereinafter contained the 
                            Landlord causing as little inconvenience as necessary and 
                            ...
                            renewals as aforesaid are being done nor shall the Landlord 
                            be liable to the Tenant in any way for loss or interruption 
                            of business of the Tenant arising therefrom or otherwise 
                            howsoever.
                        </article>
                        </div>
                    <div id="s2_14">
                        ...
                        <article>
                            ...
                            given by the Landlord to carry out any repairs for which 
                            the Tenant is liable under the Tenant's covenants and 
                            agreements herein contained; to carry out the same in 
                            accordance with such notice and to the satisfaction of 
                            the Landlord PROVIDED THAT if the Tenant shall fail to 
                            carry out such work within such time as aforesaid then 
                            the Landlord may thereupon cause the same to be done and 
                            recover the cost thereof from the  Tenant  but  without 
                    ...
                    <div id="s2_15">
                        ...
                        <article>
                            Not to make without the previous molten consent of the 
                            Landlord first had and obtained (which consent shall 
                            not be unreasonably withheld) structural alterations, 
                            partitions or structural additions in or to the Demised 
                            Premises or to the Landlords  fixtures. If the Landlord 
                            ...
                            <li>
                               ...
                               be approved by the Landlord or its agent.
                            <li>
                               (ii)The Tenant shall at its own cost and expense 
                            ...
                            <li>
                               (iii)Any such alterations partitions additions 
                                ...
                                the Tenant and the Tenant shall reinstate the 
                                Demised Premises to then original condition at 
                                the Tenant's own  expense and cost prior to the 
                                expiration or sooner determination o' this lease  
                                PROVIDED ALWAYS that any improvements undertaken 
                                by the Tenant which are of a permanent nature shall 
                                be forfeited to the Landlord al the expiry or sooner 
                                determination of this lease upon such terms as the 
                    ...
                    <div id="s2_16">
                        ...
                        <article>
                            ...
                            costs aid Surveyor's fees) incurred by the Landlord for 
                            the purpose of or incidental to the preparation and service 
                            of any notice requiring the Tenant to remedy a breach 
                    ...
                    <div id="s2_17">
                        ...
                        <article>
                            ...
                            the current premium. It is also the Tenant s resposibility 
                    ...
                    <div id="s2_18">
                        ...
                        <article>
                            ...
                            increased AND to repay to the Landlord all sums paid 
                            ...
                            shall have been made to the Tenant and shall be recoverable 
                            as rent AJMD ALSO -n the event of any insurance moneys 
                            being withheld or wholly or partially recoverable by 
                            reasons of any breach or non-observance of this present 
                            covenant to indemnity the Landlord in respect of of 
                            the cost or a proportionate part thereof of rebuilding 
                            or reinstating the same.
                        </article>
                        <specifics>
                            <ol type="-">
                                <li>Anything that can ba avoided to caurse fire 
                                    should be avoided</li>
                                <li>Tenant to pay the landloard any damage caurse 
                                    by his/her negligence on fire in the demised 
                                    premise.</li>
                            </ol>
                        </specifics>
                    </div>
                    <div id="s2_19">
                        ...
                        <article>
                            ...
                            against fire effected thereon by the Landlord being 
                            wholly or partially irrecoverable by reason solely on 
                            the part of any act or default of the Tenant  or the 
                            Tenant’s servants, employees, agents, licensees or 
                            visitors then and in every such case forthwith 
                            {in addition to the sad rent) to pay to the Landlord 
                            the whole or (as the case may require) a fair proportion 
                            of the costs of completely re-building and reinstating 
                            the same; any disputes as lo the proportion to be so 
                            contributed by the Tenant or otherwise in respect of 
                    ...
                    <div id="s2_20">
                        ...
                        <article>
                            ...
                            between the parties that upon any breach by the Tenant 
                            of this covenant and agreement if shall be lawful for 
                            the Landlord to re-enter upon the Demised Premises 
                            ...
                            by any person other than the Tenant, the Landlord may 
                            after default by the Tenant  collect the rent from the 
                            ...
                            transferee, sub lessee or occupant as Tenant or a release 
                            of the Tenant of the covenants and agreements on the 
                            Tenant' s part herein contained. For the purpose of 
                            this sub-clause and of the last preceding sub-clause 
                            if the Tenant is a private or public limited liability 
                    ...
                    <div id="s2_21">
                        ...
                        <article>
                            ...
                            otherwise than as a bank premises and for ancillary 
                    ...
                    <div id="s2_22">
                        ...
                        <article>
                            ...
                            with the Landlords Architects' design in size, type, 
                            color and placing and with the consent of the Landlord 
                            first had and obtained ( with the agreement that such 
                            consent shall not be unreasonably withheld) PROVIDED 
                            ALWAYS that the Landlord may at the request and cost 
                            of the Tenant affix the name and occupation of the 
                            Tenant in the frame or frames to be provided by the 
                            Landlord at or near the entrance cl the Building or 
                            ...
                            other Tenants (if any ) and as shall from ( me to time 
                    ...
                    <div id="s2_24">
                        ...
                        <article>
                            ...
                            opinion of the Landlord may be or become a nuisance 
                    ...
                    <div id="s2_25">
                        ...
                        <article>
                            At the Tenant's own expense to install in the Demised 
                            Premises such additional firefighting equipment and 
                            appliances as shall be required and approved by the 
                            Landlord if in the Landlord's opinion the trade business 
                            or occupation of the Tenant is such as for necessitate 
                            such additional equipment and appliances over and above 
                            that and those supplied by the Landlord.
                        </article>
                        <specifics>
                    ...
                    <div id="s2_26">
                        ...
                        <article>
                            ...
                            of being performed and observed by the tenant all 
                    ...
                    <div id="s2_27">
                        ...
                        <article>
                            ...
                            required to be done and at all times to keep the Landlord 
                            indemnifieds iaity in thereof 
                        </article>
                        <specifics>
                    ...
                    <div id="s2_28">
                        ...
                        <article>
                            ...
                            particulars to the Landlord of any notice, order or 
                            ...
                            as Ire Landlord may require to be displayed on the Demised 
                            Premises.
                        </article>
                        <specifics>
                    ...
                    <div id="s2_29">
                        ...
                        <article>
                            To permit the Landlord or its agent or agents a:any 
                            time during the Three months next before the expiration 
                            of the Term to enter upon the Demised Premises and to 
                            permit all persons by order in writing of the Landlord 
                            or its agent or agents to view the Demised Premises at 
                            reasonable hours in the day time without interruption 
                            AND if during the last month of the Term the Tenant 
                            shall have removed all  of the Tenant's property from 
                            the Demised Premises the Landlord may immediately enter 
                            ...
                            the Tenant tor any compensation and such acts shall have 
                    ...
                    <div id="s2_30">
                        ...
                        <article>
                            ...
                            of or a receiver or receiver and manager may be appointed 
                            of or a distress or execution be levied or enforced upon 
                            or sued out against or analogous proceedings be taken in 
                            respect of tire whole or any part of die undertaking, 
                            assets or property of the Tenant or whereby the Tenant 
                    ...
                    <div id="s2_31">
                        ...
                        <article>
                            ...
                            to yield up the Demised Premises to the Landlord with 
                            the fixtures and fittings thereto (other than the other 
                            fixtures, partitions and additions installed or erected 
                            by the Tenant (aid which are not excepted under clause 
                            2.15 (iii) which said items shall remain the property 
                            of the Tenant and the Tenant shall cause the same to be 
                            removed on or before the expiry or sooner determination 
                            of this ease) in such good and tenantable repair and 
                            condition as shall be in accordance with the Tenants 
                            covenants and agreements herein contained and with all 
                            locks, keys and fastenings complete AND the Tenant s 
                            ...
                            PROVIDED ALWAYS that nothing herein contained shad 
                            require the Tenant to leave the Demised Premises in 
                    ...
                    <div id="s2_32">
                        ...
                        <article>
                            ...
                            other disbursements but excluding the Landlord s 
                            Advocates' costs
                        </article>
                        <specifics>
                    ...
                    <div id="s2_33">
                        ...
                        <article>
                            To pay lo the Landlord by way of additional rent a 
                            Service Charge, in the amount and in the manner more 
                            particularly described in the Third Schedule, being 
                            the proportion of the operating expenses of the 
                            Building that the floor space of the Premises bears 
                            ...
                            to time expended by the Landlord in respect of:
                            <list>
                            <li>
                                i) the services of such cleaners as the Landlord 
                                shall consider necessary' for cleaning and keeping 
                                tidy the Common Parts of the Building and the windows 
                                therein and the costs of the materials used by such 
                                cleaners;
                            
                            <li>
                                ii)all electricity consumed in the Common Parts 
                                of the Building (Common Parts being those parts 
                                of the Building enjoyed or used by the Tenant in 
                            ...
                            <li>
                                iii)all water consumed in and all conservancy 
                                charges payable in respect of the Common Areas;
                            ...
                            <li>
                                vii)    the costs of all insurance policies in 
                                respect of the Building;
                            
                            <li>
                                viii)   all rates land rent taxes and other charges 
                            ...
                            <li>
                                ...
                                staff as the Landlord shall consider necessary for 
                                the protection of the exterior of the Building.
                                The following provisions shall apply in respect of 
                                this Sub-Clause 2.33
                            <list>
                            <li>
                                i)The Tenant shall pay a deposit on Service Charge 
                                equal to 3 months value of the initial Service 
                                Charge in accordance with the Fourth Schedule The 
                                landlord shall return the said sum to the Tenant 
                                upon the expiration of the Term unless the same 
                                shall have been applied by the Landlord to any of 
                                the Tenant s obligations under this Lease;
                            
                            <li>
                                ii) The amount of the operating expenses of the 
                                Building shall be computed annually for the period 
                                ending 30th day of June in each year;
                            
                            <li>
                                iii)    The Tenant shall within Thirty (30) days 
                                after the date of written notification from the 
                                Landlord or its agent pay the Landlord the amount 
                                ...
                                credit being given lo the Tenant for all the payments 
                                made in respect of the same by the Tenant to the 
                                Landlord
                            ...
                            <li>
                                ...
                                on behalf of the auditor engaged by the Landlord as 
                                soon as may be practicable after the expiration of 
                                each Financial Year and which shall relate lo such 
                                Financial Year,
                            
                            <li>
                                v)  The Certificate shall contain a fair summary 
                                of the Service Charge as costs and Expenditure 
                                during the Financial Year to which it relates:
                            
                            <li>
                                vi) A copy of the Certificate shall be supplied 
                                to the tenant as soon as practicable after it
                                shall have been signed;
                            
                            <li>
                                vii) In the event that payments made by the 
                                tenant and other tenants on account of Service 
                                Charge are less than the actual Service Charge 
                                expenses of the Landlord the tenant shall within 
                                ten (10) days of demand far such additional amount 
                                of Service Charge payments required make payment 
                                of the tenant's proportionate share of such additional
                                amount of Service Charge payments in such manner 
                                as the Landlord shall require
                            
                            <li>
                                viii)   In the event that payments made by the 
                                tenant and other tenants on account of Service 
                                Charge are more than the actual Service Charge 
                                expenses of the Landlord the Landlord may either 
                                reimburse the tenant with the proportionate excess 
                                amount or give the tenant a credit note for the 
                            ...
                            <li>
                                ...
                                Charge accounts between the Landlord and the Tenant 
                                are settled.
            ...
            <section id="s3">
                ...
                <content>
                    <p>
                    <div>
                        3. The Tenant to the intent that the obligations hereinafter 
                        set out may continue throughout the continuance of the 
                        Term hereby further covenants  and agrees with the Landlord 
                        that the Tenant-
                    </div>
                    <div>
                        <span> 
                        ...
                        <article>
                            ...
                            provisions of the Factories Act (Chapter 514) or any 
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            to the Landlord of any threatened encroachment or attempt 
                    ...
                    <div>
                        ...
                        <article>
                            Will ensure that at all times the Tenant's use of 
                            ...
                            the Building and will adhere to ail other reasonable 
                            instructions m this regard which may be issued by the
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            Demised Premises whether by the Landlord or by the 
                    ...
                    <div>
                        ...
                        <article>
                            Will give immediate notice to the Landlord in case of 
                            fire or accidents or any event that may lead to such 
                            fire and accident in the Demised 3remises or o the 
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            infested with vermin, at the Tenant' s own expense 
                            cause the same to be exterminated from t me to time 
                            to the satisfaction of the Landlord AND WILL employ 
            ...
            <section id="s4">
                ...
                <content>
                    <p>
                    <div>
                        4 The Landlord to the extent that the obligations hereinafter 
                        set out may continue throughout the continuance of the Term 
                        covenants and agrees with the Tenant as follows:-
                    </div>
                    <div>
                        <span>
                        ...
                        <article>
                            ...
                            washing conveniences in common use by the  Tenant,   
                            the Landlord  and  other  Tenants (if any) during  
                            such  hours  as the  Landlord may reasonably decide
                            ...
                            tenantable repair together with the root , foundations, 
                            outside waifs and main structure of the Building 
                            PROVIDED ALWAYS that the Landlord shall not be liable 
                            for any damage to persons or property caused by or 
                            resulting from or arising out of the default of any 
                            tenants of the Building or any portion thereof, their 
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            as the Landlord may consider appropriate and to procure
                            ...
                            of any act or default of the Tenant or (he servant or 
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            or policies of insurance effected by the Landlord 
                            shall not have been vitiated or payment of the policy 
                            moneys refused in whole or in part as a consequence
                            of any act of default of the Tenant or of any servant ,
                            employee, agent licensee or visitor of the Tenant, to
                            ...
                            are rendered wholly untenantable by fire or other 
                            cause and if the Landlord shall decide no! to restore 
                            reinstate or rebuild the same or it the Building shall
                            be so damaged that the Landlord shall decide to demolish 
                            it or to rebuild it then and in any case,the Landlord 
                            may within Ninety (90) days after such fire or other 
                            cause give to the Tenant notice in writing in the manner 
                            hereinafter provided for the giving of notices of such 
                            the Landlord's decision and thereupon the Term shall 
                            be determined by lapse of time upon the Seventh day 
                            after such notice is given  and the Tenant shall forthwith 
                            vacate the Demised Premises and deliver up the same 
                            to the Landlord and provided that the Tenant is not in 
                            default under this lease then but not otherwise the 
                            Tenant’s liability for rent shall cease as from the day 
                            following the occurrence of such fire or other cause and 
                            PROVIDED ALSO that if the damage or destruction snail 
                            have been due to the default neglect of the Tenant then 
                            and in such case the Tenant shall remove all debris at 
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            obligations on the part of the Landlord referred to 
                    ...
                    <div>
                        ...
                        <article>
                            That the Tenant paying the rent hereby reserved and 
                            ...
                            interruption from or by the Landlord or any person 
                            rightfully claiming from or under the Landlord.
                        </article>
                        <specifics>
                ...
                <content>
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            for occupation the Landlord will unless such damage 
                            or destruction shall have been due to the act or neglect 
                            of the Tenant or any servant employee agent or licensee 
                            or visitor the Tenant allow to the Tenant a total or 
                            proportionate abatement of the rent hereby reserved 
                            as the case may be but so that the Tenant shall only 
                    ...
                    <div>
                        ...
                        <article>
                            ...
                            of the Landlord or the Tenant herein contained or implied 
                            so long as they shall be prevented from performing the 
                            same by statutory restrictions except that if such breach 
                            shall occur as aforesaid the Landlord or die Tenant as 
                            the case may be shall remedy such bread immediately 
                            conditions permit and in the event of any such breach 
                            of a covenant or agreement on the part of the Tenant 
                            not having been remedied before the expiration or sooner 
                            determination of the Term the Tenant shall forthwith 
                            upon such expiration or sooner determination pay to the 
                            Landlord such an amount as shall be necessary to remedy 
                    ...
                    <div>
                        ...
                        <article>
                            If the Tenant shall default in the performance or 
                            observance of any of the covenants agreement conditions 
                            stipulations and provisions herein contained or implied 
                            and on the Tenant's part to he performed or observed 
                            the Landlord may after giving the Tenant Fourteen (14) 
                            days, notice perform the same for the account of the 
                            Tenant and if the Landlord shall make any expenditure 
                            ...
                            Tenant to the Landlord -within Thirty (30) days of the 
                            furnishing or rendering to the Tenant of any bill or 
                            statement therefor;
                        </article>
                    </div>
                    <div>
                        ...
                        <article>
                            The failure of the Landlord to seek redress for violation 
                            ...
                            regulations from time to time promulgated by the 
                            Landlord shall not prevent any subsequent act which 
                            would have originally constituted a violation from 
                            having all the force and effect of an original violation 
                            AND the receipt by the Landlord of any rent with the 
                            ...
                            such breach NOR shall the failure of the Landlord 
                            to enforce any such rule or regulation as aforesaid 
                            against the Tenant be deemed to be a waiver of any 
                            such rules or regulations unless such waver be expressly 
                            made by the Landlord in writing NOR shall any payment 
                            by the Tenant or any receipt by the Landlord of a lesser 
                            ...
                            the Landlord may accept any such cheque or payment 
                            without prejudice to the Landlord's right to recover 
                    ...
                    <div>
                        ...
                        <article>
                            No delay by the Landlord in exercising any of its right 
            ...
            <section id="s6">
                ...
                <content>
                    ...
                    <div>
                        ...
                        <article>
                            The Landlord shall hold the deposit reserved in clause 
                            2.1 above to the credit of the Tenant's account (without 
                    ...
                    <li>
                        (ii)    PROVIDED ALWAYS that in the event that the Tenant 
                        ...
                        and on the pad of the Tenant to he performed and observed 
                        resulting in any loss damage or expenses to the Landlord 
                        then such sum as aforesaid or so much thereof as nary be 
                        necessary may be applied by the Landlord in making good 
                        any such loss, default or damage or expense but without 
                        prejudice to any right of action or remedy of the Landlord 
                        against the Tenant in respect of such non-payment or breach 
            ...
            <section id="s7">
                ...
                <content>
                    <p>
                        7 Either party may terminate this lease for reason of breach 
                        ...
                        of his/her intention so to do and the Tenant shall at all 
                        ...
                        contained and on the part of the Tenant to he performed and 
                        observed and shall pay all costs properly incurred by the 
                        Landlord in effecting completion, stamping and registration 
                        of a f ormal surrender of this Lease.
                    </p>
                </content>
            </section>
            <section id="s8">
                ...
                <content>
                    <p>
                        ...
                        and provisions herein contained or implied and on the part 
                        of the Tenant lo be observed or performed then subject as 
                        hereinafter provided the Landlord shall grant to Use Tenant 
                        ...
                        created by an  independent value agreed upon by the Landlord 
            ...
            <section id="s9">
                ...
                <content>
                    <p>
                        ...
                        last known address in  Kenya and any notice to the Landlord 
                        shall be sufficiency served if served on any agent authorised 
                        by the landlord to receive or who has in fact or their behalf 
            ...
            <section id="s10">
                ...
                <content>
                    <p>
                        10. The  Tenant  hereby  agrees  to  accept  this Lease 
            ...
            <section id="s11">
                ...
                <content>
                    <div>
                        ...
                        Al that floor space comprising by measurement 2,916 
                        [Two Thousand. Nine Hundred and Sixteen) square feet or 
                        thereabouts of  lettable space on die first floor and 
                        ground floor of the Building together with the use of 
                        common areas in the Building inclusive of the rear yard
                        which premises are shaded and marked an the Plan of the 
                        Building registered in the Registry of Documents in Volume 
                        Folio File edged and marked red (a copy of which Plan is 
                        ...
                        The monthly gross rent calculated at the rate of Kshs 50/=
                        per square foot translation to a total monthly rent of Kenya 
                        Shillings One Hundred and Forty Five Thousand and Eight 
                        Hundred (Kshs 145,800) (exclusive of VAT) payable quarterly 
                        in advance, it being agreed that such Rent shall be increased 
                        at the rate of Ten [10%) per cent after every two years 
                        of the Term. The Tenant shall pay Service Charge at the 
                        monthly rate of Kenya Shillings One Thousand Five Hundred:
                        (Kshs. 1.500) payable quarterly in advance together with 
                        the Rent.
                        <div/>
                        <div>
                            <p>THE FOURTH SCHEDULE: THE DEPOSIT</p>
                        The deposit payable by the Tenant shall be equivalent to 
                        three months' rent for the Iasi quarter of the term being 
                        Kenya Shillings Five Hundred and Twenty Mine Thousand Two 
                        Hundred and Fifty Four, (Kshs, 523,254}, The deposit shall 
                        be held by the Landlord pursuant to clause 6 of this lease.
                        Deposit for Service Charge shall be equivalent to three 
                        months' service charge for the first quarter of the term i.e. 
                        Kenya Shillings Four Thousand. Five Hundred [Kshs, 4,500) 
                        which shall be held by the Landlord pursuant to clause 2.33 
                        of this Lease
                        <div/>
            ...
            <section id="s12">
                ...
                <content>
                    <div>
                        IN  WITNESS  WHEREOF  this  Lease has been  duly executes  
                        by  the  parties  hereto  the  date and  year first
                        hereinbefore written SEALED with the common seat of
                        THE LANDLORD in the presence of Director  Director/Secretary
                        I  CERTIFY that   the above named. a Director  and
                        a Director'Secretary of the Landlord appeared before me on 
                        the day of  201 and (being Known to me ) acknowledged the 
                        above signatures or mark to be theirs and that they had 
                        freely and voluntarily executed this instrument ad understood 
                        its contents Advocate's signature SIGNED by 1 the duty 
                        authorised Attorney of the ] TENANT by virtue of P.A No . . .
                        J. In the presence of: J ADVOCATE II CERTIFY that a duly 
                        constituted Attorney of the above named Tenant appeared 
                        before me on the . . . day of 201 and (being known to me )
                        acknowledged the above signature or mark to be theirs and 
                        that they had freely and voluntarily executed this Instrument 
                        ad understock it’s contend. Advocate’s signature
                    </div>
                    </content>
        </div>
    </body>
